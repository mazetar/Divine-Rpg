...
/***
 * Total Clone of BlockDivineStatue!
 * I should probably not do it like this, but I'd like for these to be seperate.
 * 
 * @author Mazetar
 */
public class DivineAltar extends Block {
    public DivineModel model;
    public ResourceLocation texture;
    
    public DivineAltar(int ID, ResourceLocation texture, DivineModel model) {
     ...
     * @author Mazetar
     */
    public DivineAltar setUnlocalizedName(String name) {
    ...
    public TileEntity createTileEntity(World world, int metadata) {
        return new TileDivineAltar(texture, model);
    }
