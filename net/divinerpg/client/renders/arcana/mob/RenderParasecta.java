package net.divinerpg.client.renders.arcana.mob;
...
public class RenderParasecta extends RenderLivingDivine
{
    private float scale;

    public RenderParasecta(ModelBase var1, float var2, float var3, ResourceLocation loc)
    {
