...
public class RenderDivineStatue extends TileEntitySpecialRenderer {

    public RenderDivineStatue() {
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y,
            double z, float tick) {
        if (te instanceof TileDivineStatue) {
            TileDivineStatue teds = (TileDivineStatue)te;
            ...
            // Bind texture
            Minecraft.getMinecraft().func_110434_K().func_110577_a(teds.texture);
