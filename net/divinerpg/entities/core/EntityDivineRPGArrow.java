package net.divinerpg.entities.core;
...
public class EntityDivineRPGArrow extends EntityArrow {
    ...
    public EntityDivineRPGArrow(World var1, EntityLivingBase var2, EntityLivingBase var3, float var4, float var5, int arrowID) {
        super(var1, var2, var3, var4, var5);
        setID(arrowID);
    }
    
    public EntityDivineRPGArrow(World var1, EntityLivingBase var2, float var3, int arrowID) {
