...
public class EntityJungleBat extends EntityDivineMob
{
    ...
    {
        super(par1World, 0.4F, 120, 20, 16.0F);
        this.setSize(0.5F, 0.9F);
        this.setIsBatHanging(true);
        this.tasks.addTask(0, new EntityAIAttackOnCollide(this, EntityPlayer.class, this.getMoveSpeed(), false));
        this.tasks.addTask(1, new EntityAIMoveTowardsRestriction(this, this.getMoveSpeed()));
