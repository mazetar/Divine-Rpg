...
public class EntityEnderArrow extends EntityArrow
{
    ...
    public EntityEnderArrow(World par1World, EntityLivingBase par2EntityLiving, EntityLivingBase par3EntityLiving, float par4, float par5)
    {
        super(par1World, par2EntityLiving, par3EntityLiving, par4, par5);
    }
    
    public EntityEnderArrow(World par1World, EntityLivingBase par2EntityLiving, float par3)
    {
