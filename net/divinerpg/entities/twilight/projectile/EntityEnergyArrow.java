...
public class EntityEnergyArrow extends EntityArrow
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityEnergyArrow(World var1, EntityLivingBase var2, EntityLivingBase var3, float var4, float var5)
    {
        super(var1);
    ...
    public void onCollideWithPlayer(EntityPlayer var1)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !var1.inventory.addItemStackToInventory(new ItemStack(TwilightItemHelper.AzuriteArrow, 1)))
            {
                var2 = false;
            }
        }
