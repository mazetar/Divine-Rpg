...
public class EntityWreck extends EntityDivineMob implements IRangedAttackMob, IBossDisplayData
{
    ...
    public void manageAbilities()
    {
    	...
    	if (this.getHealth() < this.getMaxHealth() / 3 && ability == DEFAULT)
    	{
    		stage = RANGED;
    		this.tasks.removeTask(meleeAI);
    	}
    	else if (this.getHealth() < this.getMaxHealth() * 2 / 3 && ability == DEFAULT)
    	{
    		stage = ARCANA;
    ...
    private void message()
    {
        ...
        for (int var1 = 0; var1 < list.size(); ++var1)
        {
        	if (list.get(var1) instanceof EntityPlayer)
        	{
        		...
        		{
        		case CHARGE:
        			var2.addChatMessage("CHARRGEE!");
        			break;
        		case PULL:
        			this.playSound("mob.RPG.Wreck.FeelSoulArksiane", 1.0F, 1.0F);
        			var2.addChatMessage("Come Feel the Soul of Arksiane.");
        			break;
        		case FIRE:
        			var2.addChatMessage("Arksiane, give me fire!");
        			break;
        		case FREEZE:
        			this.playSound("mob.RPG.Wreck.StopAtOnce", 1.0F, 1.0F);
        			var2.addChatMessage("Stop at once in the name of the great Arksiane!");
        			break;
        		case SPEED:
        			this.playSound("mob.RPG.Wreck.Speed", 1.0F, 1.0F);
        			var2.addChatMessage("Speed!");
        			break;
        		case EXPLOSIONS:
        			this.playSound("mob.RPG.Wreck.Explosions", 1.0F, 1.0F);
        			var2.addChatMessage("Explosions!");
        			break;
        		case STRENGTH:
        			this.playSound("mob.RPG.Wreck.Strength", 1.0F, 1.0F);
        			var2.addChatMessage( "Strength!");
        			break;
        		default:
        			break;
        		}
