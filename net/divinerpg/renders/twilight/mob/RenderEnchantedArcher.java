...
public class RenderEnchantedArcher extends RenderLivingDivine
{
    protected ModelEnchantedArcher modelBipedMain;
    protected float field_77070_b;

    public RenderEnchantedArcher(ModelEnchantedArcher var1, float var2, ResourceLocation loc)
    {
        this(var1, var2, 1.0F, loc);
        this.modelBipedMain = var1;
    }

    public RenderEnchantedArcher(ModelEnchantedArcher var1, float var2, float var3, ResourceLocation loc)
    {
        super(var1, var2, loc);
        this.modelBipedMain = var1;
