package net.divinerpg.renders.vethea.mob;
...
public class RenderKarosArrow extends Render
{
    ...
    public void renderArrow(EntityVetheanWrathArrow par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    protected ResourceLocation func_110779_a(EntityVetheanWrathArrow par1EntityArrow)
    {
    ...
    {
        return this.func_110779_a((EntityVetheanWrathArrow)par1Entity);
    }
    ...
    {
        this.renderArrow((EntityVetheanWrathArrow)par1Entity, par2, par4, par6, par8, par9);
    }
}
