...
public final class IconHelper {
	...
	public static void massLoadItemSprites(IconRegister ir) {
		...
		InputStream stream = DivineRPGTwilight.class.getResourceAsStream("/assets/drpg/textures/items.txt");
		try {
			...
			while ((line = bufferedReader.readLine()) != null) {
				...
				if(line.endsWith(".png")) {
					...
					Icon icon = ir.registerIcon("drpg:" + texName);
	...
	public static void massLoadBlockSprites(IconRegister ir) {
		...
		InputStream stream = DivineRPGTwilight.class.getResourceAsStream("/assets/drpg/textures/blocks.txt");
		try {
			BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(stream));
			String line = null;
			while ((line = bufferedReader.readLine()) != null) {
