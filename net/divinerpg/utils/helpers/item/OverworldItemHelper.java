...
import net.divinerpg.items.overworld.NYI.ItemBowCannon;
import net.divinerpg.items.overworld.NYI.ItemFrostSword;
import net.divinerpg.items.overworld.NYI.ItemMaelstrom;
import net.divinerpg.items.overworld.NYI.ItemPoisonSaber;
import net.divinerpg.items.overworld.NYI.ItemSerenadeDeath;
...
public class OverworldItemHelper 
{
	...
	public static void initWeaponsAndTools() {
		...
		frostCannon = new ItemBowCannon(cfg.frostCannonID, 8, 1, Item.snowball.itemID, 5, "xolovon.GhastCannon", "xolovon.maelstrom").func_111206_d("FrostCannon"); //TODO: Details may be wrong for the constructors args.
		soundOfMusic = new ItemSoundMusic(cfg.soundOfMusicID).func_111206_d("SoundOfMusic");
		crabClawCannon = new ItemBowCannon(cfg.crabClawCannonID, 22, 1, Block.cactus.blockID, 5, "xolovon.maelstrom", "xolovon.maelstrom").func_111206_d("CrabClawCannon").setUnlocalizedName("crabclawcannon").setCreativeTab(DivineTabs.tabRanged);
		bowheadCannon = new ItemBowCannon(cfg.bowheadCannonID, 16, 1, Block.cactus.blockID, 3, "xolovon.GhastCannon", "xolovon.maelstrom").func_111206_d("BowheadCannon");//.setIconIndex(28).setItemName("bowheadcannon").setCreativeTab(tabRanged);
		soundOfMusic = new ItemSoundMusic(cfg.soundOfMusicID).func_111206_d("SoundOfMusic");
