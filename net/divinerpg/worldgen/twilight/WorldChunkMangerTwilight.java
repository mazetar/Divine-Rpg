...
public class WorldChunkMangerTwilight extends WorldChunkManager {
    ...
    protected WorldChunkMangerTwilight() {
        this.myBiomeCache = new BiomeCache(this);
        this.myBiomesToSpawnIn = new ArrayList<BiomeGenBase>();
        this.myBiomesToSpawnIn.add(DimensionRegistry.azuriteBiome);
        this.myBiomesToSpawnIn.add(DimensionRegistry.draviteBiome);
        this.myBiomesToSpawnIn.add(DimensionRegistry.uviteBiome);
        this.myBiomesToSpawnIn.add(DimensionRegistry.augiteBiome);
        this.myBiomesToSpawnIn.add(DimensionRegistry.mythilBiome);
    }

    public WorldChunkMangerTwilight(long seed, WorldType worldtype) {
        this();
        
        GenLayer[] agenlayer = GenLayerTwilight.makeTheWorld(seed);
    ...
    public BiomeGenBase getBiomeGenAt(int x, int z) {
        ...
        if (biome == null) {
            return DimensionRegistry.draviteBiome;
        }
    ...
    public BiomeGenBase[] getBiomesForGeneration(
        ...
        for (int i = 0; i < par4 * par5; ++i) {
            if (aint[i] >= 0) {
                ...
                par1ArrayOfBiomeGenBase[i] = DimensionRegistry.draviteBiome;
            }
        }
