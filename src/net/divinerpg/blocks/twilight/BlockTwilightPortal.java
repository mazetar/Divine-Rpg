...
public class BlockTwilightPortal extends BlockBreakable
{
    ...
    public BlockTwilightPortal(int var1, String var2)
    {
            ...
            if (this.firetick == this.firemax && this.firemax != 0)
            {
                if (var5 instanceof EntityPlayerMP)
                {
                    ...
                    if (var5.ridingEntity == null && var5.riddenByEntity == null && var5 instanceof EntityPlayer)
                    {
                        ...
                        {
                            var6.mcServer.getConfigurationManager().transferPlayerToDimension(var6, 0, new TeleporterTwilight(var6.mcServer.worldServerForDimension(0)));
                        }
                    }
                }
