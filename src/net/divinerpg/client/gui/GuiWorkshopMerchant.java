...
public class GuiWorkshopMerchant extends GuiContainer
{
    ...
    public GuiWorkshopMerchant(ContainerWorkshopMerchant container)
    {
        super(container);
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3)
    {
        ...
        mc.func_110434_K().func_110577_a(ResourceGuiLoc.GUI_TINKERER);
    ...
    public void drawScreen(int var1, int var2, float var3)
    {
        ...
        if (var4 != null && !var4.isEmpty())
        {
            ...
            {
                GL11.glBindTexture(GL11.GL_TEXTURE_2D, mc.renderEngine.func_110581_b(ResourceGuiLoc.GUI_TRADING).func_110552_b());
                GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
