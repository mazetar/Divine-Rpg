...
public class EntityLivingStatueArrow extends EntityArrow
{
    ...
    public EntityLivingStatueArrow(World var1, EntityLivingBase var2, EntityLivingBase var3, float var4, float var5)
    {
        super(var1);
        this.setDamage(26);
    ...
    public EntityLivingStatueArrow(World var1, EntityLivingBase var2, float var3)
    {
        super(var1);
        this.setDamage(26);
        this.shootingEntity = var2;
