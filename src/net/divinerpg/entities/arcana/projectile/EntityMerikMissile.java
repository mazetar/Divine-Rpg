...
public class EntityMerikMissile extends EntityThrowable implements IProjectile
{
    ...
    public EntityMerikMissile(World par1World, EntityLivingBase par2EntityLiving)
    {
        super(par1World);
    ...
    public EntityMerikMissile(World par1World, EntityLivingBase par2EntityLiving, float par3, int par4)
    {
        super(par1World);
        this.age = par4;
