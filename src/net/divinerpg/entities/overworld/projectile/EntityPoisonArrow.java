...
public class EntityPoisonArrow extends EntityArrow
{
    ...
    public EntityPoisonArrow(World var1, EntityLivingBase var2, EntityLivingBase var3, float var4, float var5)
    {
        super(var1);
    ...
    public EntityPoisonArrow(World var1, EntityLivingBase var2, float var3)
    {
        super(var1);
        this.shootingEntity = var2;
        this.doesArrowBelongToPlayer = var2 instanceof EntityPlayer;
    ...
    public void onUpdate()
    {
        ...
        if (this.inGround)
        {
            var16 = this.worldObj.getBlockId(this.xTile, this.yTile, this.zTile);
            int var17 = this.worldObj.getBlockMetadata(this.xTile, this.yTile, this.zTile);

            if (var16 == this.inTile && var17 == this.inData)
            {
                ++this.ticksInGround;
        ...
        else
        {
            ...
            for (var9 = 0; var9 < var6.size(); ++var9)
            {
                ...
                if (var11.canBeCollidedWith() && (var11 != this.shootingEntity || this.ticksInAir >= 5))
                {
                    ...
                    var13 = var12.calculateIntercept(var18, var3);
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    if (var4.entityHit.attackEntityFrom(var21, var20))
                    {
                        if (var4.entityHit instanceof EntityLiving)
                        {
                            EntityLiving var24 = (EntityLiving)var4.entityHit;
                            var24.addPotionEffect(new PotionEffect(Potion.poison.id, 3 * 20, 0));
