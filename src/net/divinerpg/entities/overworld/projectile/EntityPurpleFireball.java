...
public class EntityPurpleFireball extends EntityFireball
{
    ...
    public EntityPurpleFireball(World par1World)
    {
        super(par1World);
        this.setSize(0.3125F, 0.3125F);
    }

    public EntityPurpleFireball(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
    {
        super(par1World);
    ...
    public EntityPurpleFireball(World par1World, EntityLivingBase par2EntityLiving, double par3, double par5, double par7)
    {
        super(par1World);
    ...
    protected void onImpact(MovingObjectPosition par1MovingObjectPosition)
    {
        if (!this.worldObj.isRemote)
        {
            ...
            {
                this.worldObj.setBlock(var2, var3, var4, Block.fire.blockID, 0, 3);
            }
