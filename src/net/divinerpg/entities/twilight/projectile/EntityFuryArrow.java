...
public class EntityFuryArrow extends Entity
{
    ...
    public EntityFuryArrow(World var1, EntityLivingBase var2, EntityLivingBase var3, float var4, float var5)
    {
        super(var1);
    ...
    public EntityFuryArrow(World var1, EntityLivingBase var2, float var3)
    {
        super(var1);
        this.shootingEntity = var2;
