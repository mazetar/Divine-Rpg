...
public class EntityVermsillion extends EntityTameable
{
    ...
    protected void func_110147_ax() { 
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(1);
    ...
    protected void updateAITasks()
    {
    	...
    	{
    		this.setAIMoveSpeed((float) getMoveSpeed());
    		--this.waitTick;
    	...
    	{
    		--this.waitTick;
    		this.moveEntityWithHeading(0F, (float) this.getMoveSpeed());
    	}
    ...
    public boolean attackEntityAsMob(Entity var1)
    {
        ...
        var1.addVelocity((double)(-MathHelper.sin(this.rotationYaw * (float)Math.PI / 180.0F) * (float)3 * 0.5F), 0.1D, (double)(MathHelper.cos(this.rotationYaw * (float)Math.PI / 180.0F) * (float)3 * 0.5F));
        this.motionX *= 0.6D;
        this.motionZ *= 0.6D;
        ...
        else if (var2 != null && var2.itemID == VetheaItemHelper.fyrossom.itemID && !this.isAngry())
        {
            ...
            if (!this.worldObj.isRemote)
            {
                if (this.rand.nextInt(3) == 0)
                {
                    ...
                    this.setEntityHealth((int) this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111126_e());
