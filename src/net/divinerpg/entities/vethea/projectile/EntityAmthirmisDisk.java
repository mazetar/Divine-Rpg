...
public class EntityAmthirmisDisk extends EntityDisk
{
    ...
    public EntityAmthirmisDisk(World par1World, EntityLivingBase par2EntityLiving, int par3, Item i)
    {
        super(par1World, par2EntityLiving, par3, i);
    }

    public EntityAmthirmisDisk(World par1World, double par2, double par4, double par6)
    {
