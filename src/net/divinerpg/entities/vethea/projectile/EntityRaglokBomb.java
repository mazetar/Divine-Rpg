...
public class EntityRaglokBomb extends Entity
{
    ...
    public EntityRaglokBomb(World var1, EntityLivingBase var2, EntityLivingBase var3, float var4, float var5, boolean b)
    {
        super(var1);
    ...
    public EntityRaglokBomb(World var1, EntityLivingBase var2, float var3)
    {
        super(var1);
        this.shootingEntity = var2;
