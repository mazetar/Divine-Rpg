...
import net.divinerpg.models.vethea.mobs.WreckForm2;
import net.divinerpg.models.vethea.mobs.WreckForm3;
...
public class RenderWreck extends RenderLiving
{
    ...
    public RenderWreck(ModelBase var1, float var2, ResourceLocation textureLoc)
    {
        super(var1, var2);
        texture = textureLoc;
    }
