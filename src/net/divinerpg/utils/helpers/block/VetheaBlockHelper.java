...
public class VetheaBlockHelper 
{
	...
	{
    	vetheaPortal = new BlockPortalVethea(VetheaConfigHelper.vetheaPortalID, "Vethea").func_111022_d("VetheaPortal").setUnlocalizedName("Vethea Portal").setCreativeTab(CreativeTabHelper.tabBlocks);
    	dreamstone = new BlockVethea(VetheaConfigHelper.dreamstoneID, 9, Material.rock).func_111022_d("DreamStone").setUnlocalizedName("dreamstone").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        dreamdirt = new BlockVethea(VetheaConfigHelper.dreamdirtID, 11, Material.ground).func_111022_d("DreamGrass_Bottom").setUnlocalizedName("dreamdirt").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        dreamgrass = new BlockDreamgrass(VetheaConfigHelper.dreamgrassID).func_111022_d("DreamGrass").setUnlocalizedName("dreamgrass").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        dreamwood = new BlockDreamwood(VetheaConfigHelper.dreamwoodID).func_111022_d("DreamWood").setUnlocalizedName("dreamwood").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        dreamwoodLeaves = new BlockDreamwoodLeaves(VetheaConfigHelper.dreamwoodLeavesID).func_111022_d("DreamwoodLeaves").setUnlocalizedName("dreamwoodLeaves").setHardness(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        dreambricks = new BlockVethea(VetheaConfigHelper.dreambricksID, 25, Material.rock).func_111022_d("DreamBricks1").setUnlocalizedName("dreambricks").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        ...
        lunastone = new BlockVethea(VetheaConfigHelper.lunastoneID, 27, Material.rock).setBlockUnbreakable().setUnlocalizedName("lunastone").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);//TODO get a texure
        ...
        blossomingWeedwoodVine = new BlockWeedwoodVine(VetheaConfigHelper.blossomingWeedwoodVineID, 42).func_111022_d("WeedWoodVineBlossomed").setUnlocalizedName("blossomingWeedwoodVine").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        
        cryptWall = new BlockVethea(VetheaConfigHelper.cryptWallID, 43, Material.rock).setBlockUnbreakable().setUnlocalizedName("cryptWall").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);//TODO add Texture (no texture
        smoothGlass = new BlockSmoothGlass(VetheaConfigHelper.smoothGlassID, 44, Material.glass).func_111022_d("SmoothGlass").setStepSound(Block.soundGlassFootstep).setUnlocalizedName("smoothGlass").setHardness(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        villageLamp = new BlockVethea(VetheaConfigHelper.villageLampID, 45, Material.glass).func_111022_d("VillageLamp").setUnlocalizedName("villageLamp").setLightValue(1.0F).setStepSound(Block.soundGlassFootstep).setHardness(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        cellLamp = new BlockVethea(VetheaConfigHelper.cellLampID, 57, Material.glass).func_111022_d("CellLamp").setUnlocalizedName("cellLamp").setLightValue(1.0F).setStepSound(Block.soundGlassFootstep).setHardness(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        barredDoor = new BlockBarredDoor(VetheaConfigHelper.barredDoorID, Material.iron).func_111022_d("BarredDoor").setUnlocalizedName("barredDoor").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        firecrystal = new BlockVethea(VetheaConfigHelper.firecrystalID, 60, Material.glass).func_111022_d("FireCrystal").setLightValue(0.7F).setUnlocalizedName("firecrystal").setStepSound(Block.soundGlassFootstep).setHardness(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        firelight = new BlockVethea(VetheaConfigHelper.firelightID, 60, Material.glass).func_111022_d("FireLight").setUnlocalizedName("firelight").setLightValue(1.0F).setStepSound(Block.soundGlassFootstep).setHardness(1F).setResistance(1.0F).setCreativeTab(CreativeTabHelper.tabBlocks);
        firewood = new BlockDreamwood(VetheaConfigHelper.firewoodID).setUnlocalizedName("firewood").func_111022_d("FireWood").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        firewoodLeaves = new BlockDreamwoodLeaves(VetheaConfigHelper.firewoodLeavesID).func_111022_d("FireWoodLeaves").setUnlocalizedName("firewoodLeaves").setHardness(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        firewall = new BlockVethea(VetheaConfigHelper.firewallID, 73, Material.rock).func_111022_d("FireWall").setUnlocalizedName("firewall").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        hyrewood = new BlockDreamwood(VetheaConfigHelper.hyrewoodID).func_111022_d("HyreWood").setUnlocalizedName("hyrewood").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        mintwoodLeaves = new BlockDreamwoodLeaves(VetheaConfigHelper.mintwoodLeavesID).func_111022_d("MintWoodLeaves").setUnlocalizedName("mintwoodLeaves").setHardness(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        karosHeatTileGreen = new BlockKarosHeatTileGreen(VetheaConfigHelper.karosHeatTileGreenID, false).func_111022_d("KarosHeatTile1").setBlockUnbreakable().setUnlocalizedName("karosHeatTileGreen").setHardness(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        karosHeatTileRed = new BlockKarosHeatTileRed(VetheaConfigHelper.karosHeatTileRedID, true).func_111022_d("KarosHeatTile2").setBlockUnbreakable().setUnlocalizedName("karosHeatTileRed").setHardness(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        ...
        everstone = new BlockVethea(VetheaConfigHelper.everstoneID, 140, Material.rock).func_111022_d("EverStone").setBlockUnbreakable().setUnlocalizedName("everstone").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        ...
        hyrewoodLeaves = new BlockDreamwoodLeaves(VetheaConfigHelper.hyrewoodLeavesID).func_111022_d("HyreWoodLeaves").setUnlocalizedName("hyrewoodLeaves").setHardness(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        ...
        mintwood = new BlockDreamwood(VetheaConfigHelper.mintwoodID).setUnlocalizedName("mint").func_111022_d("MintWood").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        ...
        cracklespike = new BlockVetheaPlant(VetheaConfigHelper.cracklespikeID).func_111022_d("CrackleSpike").setUnlocalizedName("cracklespike").setHardness(0.0F).setStepSound(Block.soundGrassFootstep).setCreativeTab(CreativeTabHelper.tabHerb);
        ...
        shimmer = new BlockShimmer(VetheaConfigHelper.shimmerID).setLightValue(0.4F).func_111022_d("Shimmer").setUnlocalizedName("shimmer").setHardness(0.0F).setStepSound(Block.soundGrassFootstep).setCreativeTab(CreativeTabHelper.tabHerb);
        hiveWall = new BlockVethea(VetheaConfigHelper.hiveWallID, 127, Material.glass).setLightValue(0.533F).func_111022_d("HiveWalls").setUnlocalizedName("hiveWall").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        ...
        chamberWall1 = new BlockVethea(VetheaConfigHelper.chamberWallID, 91, Material.rock).func_111022_d("ChamberWall1").setBlockUnbreakable().setUnlocalizedName("chamberWall").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        chamberWall2 = new BlockVethea(VetheaConfigHelper.chamberWall1ID, 92, Material.rock).func_111022_d("ChamberWall2").setBlockUnbreakable().setUnlocalizedName("chamberWall1").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        chamberWall3 = new BlockVethea(VetheaConfigHelper.chamberWall2ID, 93, Material.rock).func_111022_d("ChamberWall3").setBlockUnbreakable().setUnlocalizedName("chamberWall2").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        whiteEverstone = new BlockVethea(VetheaConfigHelper.whiteEverstoneID, 139, Material.rock).func_111022_d("WhiteEverstone").setBlockUnbreakable().setUnlocalizedName("whiteEverstone").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        darkEverstone = new BlockVethea(VetheaConfigHelper.darkEverstoneID, 138, Material.rock).func_111022_d("DarkEverstone").setBlockUnbreakable().setUnlocalizedName("darkEverstone").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        
        wreckAltar = new BlockWreckAltar(VetheaConfigHelper.wreckAltarID).func_111022_d("WreckAltar").setUnlocalizedName("wreckAltar").setBlockUnbreakable().setResistance(999F).setCreativeTab(CreativeTabHelper.tabBlocks);
        raglokAltar = new BlockRaglokAltar(VetheaConfigHelper.raglokAltarID).func_111022_d("RaglokAltar").setUnlocalizedName("raglokAltar").setBlockUnbreakable().setResistance(999F).setCreativeTab(CreativeTabHelper.tabBlocks);
        karosAltar = new BlockKarosAltar(VetheaConfigHelper.karosAltarID).func_111022_d("KarosAltar").setUnlocalizedName("karosAltar").setBlockUnbreakable().setResistance(999F).setCreativeTab(CreativeTabHelper.tabBlocks);
        lunicAltar = new BlockLunicAltar(VetheaConfigHelper.lunicAltarID).func_111022_d("LunicAltar").setUnlocalizedName("lunicAltar").setBlockUnbreakable().setResistance(999F).setCreativeTab(CreativeTabHelper.tabBlocks);
        quadroticAltar = new BlockVethea(VetheaConfigHelper.quadroticAltarID, 137, Material.rock).func_111022_d("QuadroticAltar").setUnlocalizedName("quadroticAltar").setBlockUnbreakable().setResistance(999F).setCreativeTab(CreativeTabHelper.tabBlocks);
        
        infusionTable = new BlockInfusionTable(VetheaConfigHelper.infusionTableID).func_111022_d("InfusionTable").setBlockUnbreakable().setUnlocalizedName("infusionTable").setBlockUnbreakable().setResistance(999F).setCreativeTab(CreativeTabHelper.tabBlocks);
        hungerstone1 = new BlockVethea(VetheaConfigHelper.hungerstone1ID, 106, Material.rock).func_111022_d("HungerStone1").setUnlocalizedName("hungerstone1").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        hungerstone2 = new BlockVethea(VetheaConfigHelper.hungerstone2ID, 107, Material.rock).func_111022_d("HungerStone2").setUnlocalizedName("hungerstone2").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        cryptFloor = new BlockVethea(VetheaConfigHelper.cryptFloorID, 79, Material.rock).func_111022_d("CryptFloor").setBlockUnbreakable().setUnlocalizedName("cryptFloor").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        ...
        karosBricks = new BlockVethea(VetheaConfigHelper.karosBricksID, 94, Material.rock).func_111022_d("KarosBrick").setBlockUnbreakable().setUnlocalizedName("karosBricks").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
        ...
        helioticBeam = (BlockHelioticBeam) new BlockHelioticBeam(VetheaConfigHelper.helioticBeamID).func_111022_d("HeloticBeam").setUnlocalizedName("helioticBeam").setHardness(1F).setResistance(1F).setCreativeTab(CreativeTabHelper.tabBlocks);
