...
public class BlockIceikaFurnace extends BlockContainer
{
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        else
        {
            ...
            if (var10 != null)
            {
                par5EntityPlayer.openGui(DivineRPG.instance, 17, par1World, par2, par3, par4);
            }
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlockWithNotify(par2, par3, par4, DivineRPG.iceikaFurnaceOn.blockID);
        }
        else
        {
            par1World.setBlockWithNotify(par2, par3, par4, DivineRPG.iceikaFurnace.blockID);
        }
