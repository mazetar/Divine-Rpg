...
public class BlockWhitefireFurnace extends BlockContainer
{
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlockWithNotify(par2, par3, par4, DivineRPG.whitefireFurnaceOn.blockID);
        }
        else
        {
            par1World.setBlockWithNotify(par2, par3, par4, DivineRPG.whitefireFurnace.blockID);
        }
