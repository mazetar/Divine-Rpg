...
public class ModelDramix extends ModelBase
{
  ...
  {
      this.Arm_Right.rotateAngleX = MathHelper.cos(f * 0.6662F + (float)Math.PI) * 2.0F * f1 * 0.5F;
      this.Arm_Left.rotateAngleX = MathHelper.cos(f * 0.6662F) * 2.0F * f1 * 0.5F;
      this.Arm_Right.rotateAngleZ = 0.0F;
      this.Arm_Left.rotateAngleZ = 0.0F;
      this.Leg_Right.rotateAngleX = MathHelper.cos(f) * 1.4F * f1;
      this.Leg_Left.rotateAngleX = MathHelper.cos(f * 0.6662F + (float)Math.PI) * 1.4F * f1;
