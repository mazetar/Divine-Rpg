...
public class RandomPositionGenerator
{
     ...
     */
    public static Vec3 findRandomTarget(EntityAmbientCreature par0EntityCreature, int par1, int par2)
    {
     ...
     */
    public static Vec3 findRandomTargetBlockTowards(EntityAmbientCreature par0EntityCreature, int par1, int par2, Vec3 par3Vec3)
    {
     ...
     */
    public static Vec3 findRandomTargetBlockAwayFrom(EntityAmbientCreature par0EntityCreature, int par1, int par2, Vec3 par3Vec3)
    {
     ...
     */
    private static Vec3 findRandomTargetBlock(EntityAmbientCreature par0EntityCreature, int par1, int par2, Vec3 par3Vec3)
    {
