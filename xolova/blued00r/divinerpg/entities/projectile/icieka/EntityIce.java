...
public class EntityIce extends EntityThrowable
{
    ...
    public EntityIce(World par1World, EntityLiving par2EntityLiving, int par3)
    {
        this(par1World, par2EntityLiving, new ItemStack(Item.potion, 1, par3));
    }

    public EntityIce(World par1World, EntityLiving par2EntityLiving, ItemStack par3ItemStack)
    {
    ...
    public EntityIce(World par1World, double par2, double par4, double par6, int par8)
    {
        this(par1World, par2, par4, par6, new ItemStack(Item.potion, 1, par8));
    }

    public EntityIce(World par1World, double par2, double par4, double par6, ItemStack par8ItemStack)
    {
                    ...
                    while (var5.hasNext())
                    {
                        ...
                        if (var7 < 16.0D)
                        {
                            ...
                            while (var11.hasNext())
                            {
                                ...
                                {
                                    Potion.potionTypes[var13].affectEntity(this.func_85052_h(), var6, 3, var9);
                                }
                                else
                                {
                                    ...
                                    if (var14 > 20)
                                    {
                                    	if(var6 !=this.thrower)
                                    	{
                                    		var6.addPotionEffect(new PotionEffect(var13, 5 * 20, 4));
                                    	}
                                    }
                                }
                            }
