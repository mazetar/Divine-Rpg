...
class MobSpawnerData2 extends WeightedRandomItem
{
    ...
    public MobSpawnerData2(TileEntityRollumSpawner par1TileEntityMobSpawner, NBTTagCompound par2NBTTagCompound)
    {
    ...
    public MobSpawnerData2(TileEntityRollumSpawner par1TileEntityMobSpawner, NBTTagCompound par2NBTTagCompound, String par3Str)
    {
        super(1);
        this.field_92031_d = par1TileEntityMobSpawner;
