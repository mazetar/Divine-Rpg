...
public class EntityVetheanArrow extends EntityArrow
{
    ...
    public EntityVetheanArrow(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World, par2EntityLiving, par3EntityLiving, par4, par5);
    }
    
    public EntityVetheanArrow(World par1World, EntityLiving par2EntityLiving, float par3)
    {
