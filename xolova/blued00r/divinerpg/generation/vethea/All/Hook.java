...
public class Hook extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 1, j + 6, k + 0, DivineRPG.everstone.blockID);
		...
		world.setBlock(i + 2, j + 8, k + 0, DivineRPG.everstone.blockID);
		...
		world.setBlock(i + 3, j + 9, k + 0, DivineRPG.everstone.blockID);
		...
		world.setBlock(i + 4, j + 10, k + 0, DivineRPG.everstone.blockID);
		world.setBlock(i + 4, j + 11, k + 0, DivineRPG.everstone.blockID);
		world.setBlock(i + 4, j + 12, k + 0, DivineRPG.darkEverstone.blockID);
		...
		world.setBlock(i + 5, j + 3, k + 0, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 5, j + 10, k + 0, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 5, j + 11, k + 0, DivineRPG.darkEverstone.blockID);
