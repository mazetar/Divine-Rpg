...
public class InfusionOutpost extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 0, j + 6, k + 9, DivineRPG.darkEverstone.blockID);
		...
		world.setBlock(i + 4, j + 6, k + 4, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 4, j + 6, k + 5, DivineRPG.darkEverstone.blockID);
		...
		world.setBlock(i + 5, j + 6, k + 4, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 5, j + 6, k + 5, DivineRPG.darkEverstone.blockID);
		...
		world.setBlock(i + 9, j + 6, k + 9, DivineRPG.darkEverstone.blockID);
