...
public class Pickaxe extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 2, j + 3, k + 0, DivineRPG.everstone.blockID);
		...
		world.setBlock(i + 7, j + 3, k + 0, DivineRPG.whiteEverstone.blockID);
		world.setBlock(i + 7, j + 4, k + 0, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 7, j + 7, k + 0, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 7, j + 8, k + 0, DivineRPG.everstone.blockID);
		world.setBlock(i + 7, j + 9, k + 0, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 8, j + 1, k + 0, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 8, j + 2, k + 0, DivineRPG.whiteEverstone.blockID);
