...
public class ItemMusicBox extends Item
{
    ...
    {
    	//par3EntityPlayer.addStat(AchievementPageDivineRPG.tuneOfJoy, 1);
    }
    ...
    public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5)
    {
        ...
        {
            if (currentBiome == currentBiome.forest)
            {
                par2World.playSoundAtEntity(par3Entity, "biomemusic.Grass", 0.4F, 1.0F);
            }

            if (currentBiome == currentBiome.river)
            {
                par2World.playSoundAtEntity(par3Entity, "biomemusic.Grass", 0.4F, 1.0F);
            }

            if (currentBiome == currentBiome.extremeHills)
            {
                par2World.playSoundAtEntity(par3Entity, "biomemusic.Grass", 0.4F, 1.0F);
            }

            if (currentBiome == currentBiome.extremeHillsEdge)
            {
                par2World.playSoundAtEntity(par3Entity, "biomemusic.Grass", 0.4F, 1.0F);
            }

            if (currentBiome == currentBiome.plains)
            {
                par2World.playSoundAtEntity(par3Entity, "biomemusic.Grass", 0.4F, 1.0F);
            }

            if (currentBiome == currentBiome.forestHills)
            {
                par2World.playSoundAtEntity(par3Entity, "biomemusic.Grass", 0.4F, 1.0F);
            }
