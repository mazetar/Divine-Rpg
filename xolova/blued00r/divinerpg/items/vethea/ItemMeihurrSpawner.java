...
{
    public ItemMeihurrSpawner(int par1)
    {
        super(par1);
        this.maxStackSize = 1;
        ...
        else
        {
            ...
            else
            {
                if (var24.typeOfHit == EnumMovingObjectType.TILE)
                {
                    ...
                    EntityMeihurr var35 = new EntityMeihurr(par2World, (double)((float)var29 + 0.5F), (double)((float)var33 + 1.0F), (double)((float)var34 + 0.5F));
