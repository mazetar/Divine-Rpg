...
public class EntityMamormeter extends EntityMob implements IBossDisplayData, IRangedAttackMob
{
    private int special;
	...
	public EntityMamormeter(World var1)
    {
        ...
        this.tasks.addTask(4, new EntityAIArrowAttack(this, this.moveSpeed, 3, 10));
