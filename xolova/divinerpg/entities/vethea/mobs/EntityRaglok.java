...
import xolova.divinerpg.entities.vethea.projectile.EntityRaglokBomb;
        ...
        for (int var1 = 0; var1 < list.size(); ++var1)
        {
        	if (list.get(var1) instanceof EntityPlayer)
        	{
        		...
        		case LIGHTNING:
        	        ...
        	        var2.sendChatToPlayer("You think you can fight me? I am the great guardian of Heliosis!");
        			break;
        		case BLIND:
