...
import xolova.divinerpg.blocks.overworld.tileentities.TileEntityAyeracoBeamBlue;
...
public class RenderAyeracoBeamBlue extends TileEntitySpecialRenderer
{
     ...
     */
    public void renderTileEntityBeaconAt(TileEntityAyeracoBeamBlue par1TileEntityBeacon, double par2, double par4, double par6, float par8)
    {
    ...
    {
        this.renderTileEntityBeaconAt((TileEntityAyeracoBeamBlue)par1TileEntity, par2, par4, par6, par8);
    }
}