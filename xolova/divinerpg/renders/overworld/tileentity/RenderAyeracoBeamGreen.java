...
import xolova.divinerpg.blocks.overworld.tileentities.TileEntityAyeracoBeamGreen;
...
public class RenderAyeracoBeamGreen extends TileEntitySpecialRenderer
{
     ...
     */
    public void renderTileEntityBeaconAt(TileEntityAyeracoBeamGreen par1TileEntityBeacon, double par2, double par4, double par6, float par8)
    {
    ...
    {
        this.renderTileEntityBeaconAt((TileEntityAyeracoBeamGreen)par1TileEntity, par2, par4, par6, par8);
    }
}