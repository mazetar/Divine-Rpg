...
import xolova.divinerpg.blocks.overworld.tileentities.TileEntityAyeracoBeamPurple;
...
public class RenderAyeracoBeamPurple extends TileEntitySpecialRenderer
{
     ...
     */
    public void renderTileEntityBeaconAt(TileEntityAyeracoBeamPurple par1TileEntityBeacon, double par2, double par4, double par6, float par8)
    {
    ...
    {
        this.renderTileEntityBeaconAt((TileEntityAyeracoBeamPurple)par1TileEntity, par2, par4, par6, par8);
    }
}