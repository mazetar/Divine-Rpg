...
import xolova.divinerpg.blocks.overworld.tileentities.TileEntityAyeracoBeamRed;
...
public class RenderAyeracoBeamRed extends TileEntitySpecialRenderer
{
     ...
     */
    public void renderTileEntityBeaconAt(TileEntityAyeracoBeamRed par1TileEntityBeacon, double par2, double par4, double par6, float par8)
    {
    ...
    {
        this.renderTileEntityBeaconAt((TileEntityAyeracoBeamRed)par1TileEntity, par2, par4, par6, par8);
    }
}