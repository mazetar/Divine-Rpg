...
public class RenderAyeracoBeamYellow extends TileEntitySpecialRenderer
{
     ...
     */
    public void renderTileEntityBeaconAt(TileEntityAyeracoBeamYellow par1TileEntityBeacon, double par2, double par4, double par6, float par8)
    {
    ...
    {
        this.renderTileEntityBeaconAt((TileEntityAyeracoBeamYellow)par1TileEntity, par2, par4, par6, par8);
    }
}