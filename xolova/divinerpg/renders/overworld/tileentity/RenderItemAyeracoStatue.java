...
{
    private ModelAyeracoStatue dramixAltar;

    public RenderItemAyeracoStatue()
    {
        dramixAltar = new ModelAyeracoStatue();
    }
    ...
    private void renderStatue(float x, float y, float z)
    {
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture("/DivineRPG/StatueAyeraco.png");
        GL11.glPushMatrix();
