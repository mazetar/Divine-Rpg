...
{
    private ModelKOSStatue dramixAltar;

    public RenderItemKOSStatue()
    {
        dramixAltar = new ModelKOSStatue();
    }
    ...
    private void renderStatue(float x, float y, float z)
    {
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture("/DivineRPG/StatueKOS.png");
        GL11.glPushMatrix();
