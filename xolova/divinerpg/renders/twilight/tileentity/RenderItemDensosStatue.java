...
{
    private ModelDensosStatue dramixAltar;

    public RenderItemDensosStatue()
    {
        dramixAltar = new ModelDensosStatue();
    }
    ...
    private void renderStatue(float x, float y, float z)
    {
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture("/DivineRPG/StatueDensos.png");
        GL11.glPushMatrix();
