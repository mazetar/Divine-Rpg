...
{
    private ModelSFStatue dramixAltar;

    public RenderItemSFStatue()
    {
        dramixAltar = new ModelSFStatue();
    }
    ...
    private void renderStatue(float x, float y, float z)
    {
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture("/DivineRPG/StatueSF.png");
        GL11.glPushMatrix();
