...
{
    private ModelTDStatue dramixAltar;

    public RenderItemTDStatue()
    {
        dramixAltar = new ModelTDStatue();
    }
    ...
    private void renderStatue(float x, float y, float z)
    {
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture("/DivineRPG/StatueTD.png");
        GL11.glPushMatrix();
