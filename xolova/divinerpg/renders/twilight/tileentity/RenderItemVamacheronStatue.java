...
{
    private ModelVamacheronStatue dramixAltar;

    public RenderItemVamacheronStatue()
    {
        dramixAltar = new ModelVamacheronStatue();
    }
    ...
    private void renderStatue(float x, float y, float z)
    {
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture("/DivineRPG/StatueVamacheron.png");
        GL11.glPushMatrix();
