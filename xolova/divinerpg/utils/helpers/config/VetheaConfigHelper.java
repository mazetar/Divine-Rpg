...
{ 
	...
	{
    	dreamstoneID = config.getTerrainBlock("Vethea Gen", "dreamstone", 220, "").getInt();
        dreamgrassID = config.getTerrainBlock("Vethea Gen", "dreamgrass", 221, "").getInt();
        dreamdirtID = config.getTerrainBlock("Vethea Gen", "dreamdirt", 222, "").getInt();
        firecrystalID = config.getTerrainBlock("Vethea Gen", "firecrystalID", 223, "").getInt();
