...
public class ArcanaItemHelper 
{
	...
	public static void init()
	{
	    ...
	    fireStockItem = new ItemDivineRPG(ArcanaConfigHelper.fireStockItemID).setUnlocalizedName("fireStockItem").setCreativeTab(CreativeTabHelper.tabHerb);
        ...
        veiloItem = new ItemDivineRPG(ArcanaConfigHelper.veiloItemID).setUnlocalizedName("veiloItem").setCreativeTab(CreativeTabHelper.tabHerb);
        ...
        marsineItem = new ItemDivineRPG(ArcanaConfigHelper.marsineItemID).setUnlocalizedName("marsineItem").setCreativeTab(CreativeTabHelper.tabHerb);
