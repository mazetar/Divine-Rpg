...
public class TeleporterIceika extends Teleporter
{
    ...
    {
        return var1.getBlockId(var2, var3, var4) == IceikaBlockHelper.iceikaPortal.blockID;
    }
    ...
    private void makePortalAt(World var1, int var2, int var3, int var4)
    {
        ...
        var1.setBlock(var2 + 0, var3 + 1, var4 + 1, IceikaBlockHelper.iceikaPortal.blockID);
        var1.setBlock(var2 + 1, var3 + 1, var4 + 1, IceikaBlockHelper.iceikaPortal.blockID);
        var1.setBlock(var2 + 0, var3 + 2, var4 + 1, IceikaBlockHelper.iceikaPortal.blockID);
        var1.setBlock(var2 + 1, var3 + 2, var4 + 1, IceikaBlockHelper.iceikaPortal.blockID);
        var1.setBlock(var2 + 0, var3 + 3, var4 + 1, IceikaBlockHelper.iceikaPortal.blockID);
        var1.setBlock(var2 + 1, var3 + 3, var4 + 1, IceikaBlockHelper.iceikaPortal.blockID);
