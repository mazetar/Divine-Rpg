...
public class Trident extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 1, j + 5, k + 0, DivineRPG.darkEverstone.blockID);
		...
		world.setBlock(i + 2, j + 5, k + 0, DivineRPG.whiteEverstone.blockID);
		world.setBlock(i + 2, j + 6, k + 0, DivineRPG.whiteEverstone.blockID);
		...
		world.setBlock(i + 5, j + 1, k + 0, DivineRPG.darkEverstone.blockID);
		...
		world.setBlock(i + 5, j + 6, k + 0, DivineRPG.darkEverstone.blockID);
		...
		world.setBlock(i + 6, j + 3, k + 0, DivineRPG.everstone.blockID);
		world.setBlock(i + 6, j + 4, k + 0, DivineRPG.everstone.blockID);
		world.setBlock(i + 6, j + 5, k + 0, DivineRPG.whiteEverstone.blockID);
		world.setBlock(i + 6, j + 6, k + 0, DivineRPG.whiteEverstone.blockID);
		world.setBlock(i + 6, j + 7, k + 0, DivineRPG.whiteEverstone.blockID);
		world.setBlock(i + 6, j + 8, k + 0, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 7, j + 0, k + 0, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 7, j + 1, k + 0, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 7, j + 2, k + 0, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 7, j + 3, k + 0, DivineRPG.everstone.blockID);
		...
		world.setBlock(i + 8, j + 3, k + 0, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 8, j + 4, k + 0, DivineRPG.everstone.blockID);
		...
		world.setBlock(i + 10, j + 5, k + 0, DivineRPG.whiteEverstone.blockID);
		world.setBlock(i + 10, j + 6, k + 0, DivineRPG.whiteEverstone.blockID);
		world.setBlock(i + 10, j + 7, k + 0, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 11, j + 4, k + 0, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 11, j + 5, k + 0, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 11, j + 6, k + 0, DivineRPG.darkEverstone.blockID);
