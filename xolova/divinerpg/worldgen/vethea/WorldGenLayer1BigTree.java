...
public class WorldGenLayer1BigTree extends WorldGenerator
{
        ...
        for (var11[par5] = var10[par5]; var12 <= var7; ++var12)
        {
            ...
            while (var13 <= var7)
            {
                ...
                else
                {
                    ...
                    if (var14 != 0 && var14 != DivineRPGTwilight.hyrewoodLeaves.blockID)
                    {
                        ++var13;
                    }
                    else
    ...
    void generateLeafNode(int par1, int par2, int par3)
    {
        ...
        for (int var5 = par2 + this.leafDistanceLimit; var4 < var5; ++var4)
        {
            ...
            this.genTreeLayer(par1, var4, par3, var6, (byte)1, DivineRPGTwilight.hyrewoodLeaves.blockID);
        }
    }
    ...
    void generateTrunk()
    {
        ...
        this.placeBlockLine(var5, var6, DivineRPGTwilight.hyrewood.blockID);
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] var3 = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; var1 < var2; ++var1)
        {
            ...
            {
                this.placeBlockLine(var3, var5, (byte)DivineRPGTwilight.hyrewood.blockID);
            }
        }
    }
    ...
    int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger)
    {
        ...
        else
        {
            ...
            for (var15 = var3[var5] + var8; var14 != var15; var14 += var8)
            {
                ...
                if (var16 != 0 && var16 != DivineRPGTwilight.hyrewoodLeaves.blockID)
                {
                    break;
                }
            }
