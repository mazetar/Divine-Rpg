            ...
            else
            {
                ...
                if ((var8 == DivineRPGTwilight.dreamgrass.blockID || var8 == DivineRPGTwilight.dreamdirt.blockID) && par4 < 256 - var6 - 1)
                {
                    ...
                    for (var16 = par4 - 3 + var6; var16 <= par4 + var6; ++var16)
                    {
                        ...
                        for (var12 = par3 - var11; var12 <= par3 + var11; ++var12)
                        {
                            ...
                            for (int var14 = par5 - var11; var14 <= par5 + var11; ++var14)
                            {
                                ...
                                {
                                    this.setBlockAndMetadata(par1World, var12, var16, var14, DivineRPGTwilight.hyrewoodLeaves.blockID, 0);
                                }
                            }
                        }
                    }
                    ...
                    for (var16 = 0; var16 < var6; ++var16)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + var16, par5, DivineRPGTwilight.hyrewood.blockID, 0);
                        }
                    }
