...
public class LightDown2 extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 0, j + 1, k + 0, DivineRPG.darkEverstone.blockID);
		...
		world.setBlock(i + 0, j + 2, k + 3, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 0, j + 3, k + 0, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 0, j + 3, k + 1, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 0, j + 3, k + 2, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 0, j + 3, k + 3, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 0, j + 5, k + 0, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 0, j + 5, k + 1, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 0, j + 5, k + 2, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 0, j + 5, k + 3, DivineRPG.darkEverstone.blockID);
		...
		world.setBlock(i + 3, j + 3, k + 2, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 3, j + 3, k + 3, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 3, j + 5, k + 0, DivineRPG.darkEverstone.blockID);
		world.setBlock(i + 3, j + 5, k + 1, DivineRPG.darkEverstone.blockID);
