...
public class LightDown4 extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 1, j + 0, k + 2, DivineRPGTwilight.firelight.blockID);
		...
		world.setBlock(i + 2, j + 0, k + 1, DivineRPGTwilight.firelight.blockID);
		world.setBlock(i + 2, j + 0, k + 2, DivineRPGTwilight.firelight.blockID);
		world.setBlock(i + 2, j + 1, k + 0, DivineRPGTwilight.darkEverstone.blockID);
		world.setBlock(i + 2, j + 1, k + 1, DivineRPGTwilight.darkEverstone.blockID);
		world.setBlock(i + 2, j + 1, k + 2, DivineRPGTwilight.darkEverstone.blockID);
