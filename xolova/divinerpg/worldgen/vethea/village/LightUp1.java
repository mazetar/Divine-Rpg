...
public class LightUp1 extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 0, j + 2, k + 2, DivineRPGTwilight.firelight.blockID);
		...
		world.setBlock(i + 1, j + 4, k + 2, DivineRPGTwilight.firelight.blockID);
		...
		world.setBlock(i + 2, j + 2, k + 0, DivineRPGTwilight.firelight.blockID);
		...
		world.setBlock(i + 2, j + 2, k + 4, DivineRPGTwilight.firelight.blockID);
		world.setBlock(i + 2, j + 3, k + 2, DivineRPGTwilight.darkEverstone.blockID);
		world.setBlock(i + 2, j + 4, k + 1, DivineRPGTwilight.firelight.blockID);
		world.setBlock(i + 2, j + 4, k + 2, DivineRPGTwilight.darkEverstone.blockID);
		world.setBlock(i + 2, j + 4, k + 3, DivineRPGTwilight.firelight.blockID);
		...
		world.setBlock(i + 3, j + 2, k + 2, DivineRPGTwilight.darkEverstone.blockID);
		world.setBlock(i + 3, j + 4, k + 2, DivineRPGTwilight.firelight.blockID);
		world.setBlock(i + 4, j + 2, k + 2, DivineRPGTwilight.firelight.blockID);
